      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row gap-10 sm:gap-12 lg:gap-16 justify-center items-center">
          {steps.map((step, index) => (
            ...
            >
              {/* Badge */}
              <div className="inline-flex items-center justify-center text-white text-xs font-poppins font-medium rounded-full mb-2 sm:mb-3 self-start bg-[#5B7C99] px-3 py-1.5 w-[70px] h-[26px]">
                Step {step.step}
              </div>

              {/* Title */}
              <h3 className="text-black font-poppins font-normal leading-tight mb-1 sm:mb-2 text-base sm:text-lg lg:text-xl">
                {step.title}
              </h3>
