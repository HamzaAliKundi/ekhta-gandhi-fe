      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8 lg:mb-12">
            <h1 className="text-2xl lg:text-4xl font-normal text-black mb-4 sm:mb-0">
              Frequently asked questions
            </h1>
            <button className="flex items-center gap-2 text-white px-6 py-2 rounded-full text-sm font-medium hover:opacity-90 transition-opacity self-start sm:self-auto"
          ...
          <div className="space-y-4">
            {faqData.map((faq, index) => (
              <div key={index} className="border-b border-gray-200 pb-4">
                ...
                >
                  <h3 className="text-base lg:text-lg font-medium text-black pr-4">
                    {faq.question}
                  </h3>
        ...
        <div>
          {/* Blogs Header */}
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8 lg:mb-12">
            <h2 className="text-2xl lg:text-4xl font-normal text-black mb-4 sm:mb-0">
              Blogs section
            </h2>
            <button className="flex items-center gap-2 text-white px-6 py-2 rounded-full text-sm font-medium hover:opacity-90 transition-opacity self-start sm:self-auto"
              style={{ backgroundColor: '#5B7C99' }}>
                ...
                <div className="relative h-64 lg:h-80 overflow-hidden">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6">
                    <div className="flex items-end justify-between">
                      <h3 className="text-white text-lg lg:text-xl font-semibold leading-tight flex-1 mr-4">
                        {blog.title}
                      </h3>
                      <button className="text-white text-sm flex items-center gap-1 opacity-90 hover:opacity-100 transition-all duration-200 hover:transform hover:translate-x-1 whitespace-nowrap">
                        Read more
                        <ArrowRight size={14} />
                      </button>
                    </div>
