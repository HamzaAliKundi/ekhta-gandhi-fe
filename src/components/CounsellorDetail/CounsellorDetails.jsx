...
const CounsellorDetails = () => {
  ...
  const TagPill = ({ children, className = "" }) => (
    <span className={`inline-block px-4 py-2 bg-gray-100 text-gray-700 rounded-full text-sm font-medium border border-gray-200 ${className}`}>
      {children}
    </span>
  );
          ...
          <div className="lg:w-80 flex-shrink-0">
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 sticky top-6">
              ...
              <div className="space-y-3">
                <button 
                  className="w-full text-white px-4 py-3 rounded-full hover:opacity-90 transition-all flex items-center justify-center gap-3 font-poppins text-base font-normal"
          ...
          <div className="flex-1">
            ...
            <div className="mb-8">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
                <h1 className="text-3xl lg:text-4xl font-poppins font-normal text-black">
                  {counselorData.name}
                </h1>
                <div className="flex items-center gap-2">
                  <Star size={24} className="text-orange-400 fill-current" />
                  <span className="text-xl font-poppins font-medium text-black">
              ...
              {/* Description */}
              <div className="mb-6">
                <p className="text-base font-poppins text-black leading-relaxed mb-3">
                  {counselorData.description}
                </p>
                <p className="text-base font-poppins text-black leading-relaxed mb-4">
                  {counselorData.additionalDescription}
                </p>
                <button 
                  className="text-blue-600 font-poppins text-base underline hover:text-blue-700 transition-colors"
            ...
            <div className="space-y-8 mb-12">
              {/* College */}
              <div>
                <h2 className="text-2xl font-poppins font-medium text-black mb-4">College</h2>
              ...
              {/* Degrees */}
              <div>
                <h2 className="text-2xl font-poppins font-medium text-black mb-4">Degrees</h2>
                <div className="flex flex-wrap gap-3">
              ...
              {/* Awards */}
              <div>
                <h2 className="text-2xl font-poppins font-medium text-black mb-4">Awards</h2>
                <div className="flex flex-wrap gap-3">
              ...
              {/* Certifications */}
              <div>
                <h2 className="text-2xl font-poppins font-medium text-black mb-4">Certifications</h2>
                <div className="flex flex-wrap gap-3">
              ...
              {/* Subjects */}
              <div>
                <h2 className="text-2xl font-poppins font-medium text-black mb-4">Subjects</h2>
                <div className="flex flex-wrap gap-3">
            ...
            {/* Student Reviews */}
            <div>
              <h2 className="text-2xl font-poppins font-medium text-black mb-6">Students Reviews</h2>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                {counselorData.reviews.map((review) => (
                  <div key={review.id} className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
                    {/* Review Header */}
                    <div className="mb-4">
                      <h3 className="text-xl font-poppins font-medium text-black mb-2">
                        {review.name}
                      </h3>
                    ...
                    {/* Show More Link */}
                    <button className="text-blue-600 font-poppins text-sm underline hover:text-blue-700 transition-colors">
                      Show more
                    </button>
                  </div>
                ))}
