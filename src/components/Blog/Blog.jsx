        ...
        <div className="min-h-screen bg-white-50 py-8 px-4 sm:px-6 lg:px-8">
            <div className="w-full max-w-7xl mx-auto">
                ...
                <div className="flex justify-between items-center mb-8 lg:mb-12">
                    <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-normal text-gray-900 font-poppins">
                        Blogs section
                    </h1>

                    {/* View More Button */}
                    <button className="px-3 py-1.5 sm:px-4 sm:py-2 text-white rounded-full hover:opacity-90 transition-colors font-poppins text-xs sm:text-sm font-normal flex items-center space-x-1.5 sm:space-x-2"
